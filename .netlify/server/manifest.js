	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getDailyAyah/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getDayPrayerTimes/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getMonthPrayerTimes/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getMonthsPrayerImage/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getMonthsPrayerTime/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getNewestNewsPost/_server.js'))
			},
			{
				id: "/api/getNewsPosts",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getNewsPosts/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getNextPrayerTime/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getTodayPrayerTimes/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getTommorowPrayerTimes/_server.js'))
			},
			{
				id: "/api/getYear",
				pattern: /^\/api\/getYear\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getYear/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getYesterdayPrayerTimes/_server.js'))
			},
			{
				id: "/app",
				pattern: /^\/app\/?$/,
