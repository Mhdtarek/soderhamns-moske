<h1>English Privacy Policy for "Söderhamns Moské" Mobile Application</h1>
  ...
  <p>We want to assure you that "Söderhamns Moské" does not collect or store any personal data, cookies, or any other form of personally identifiable information. We respect your privacy and have designed our application to operate without the need for such data.</p>

  <h3>2. Anonymous Usage Data</h3>
  <p>To enhance the performance and usability of our application, we may collect anonymous usage data. This information does not personally identify you and is used solely for analytical purposes. It helps us understand how our app is used, identify areas for improvement, and optimize the user experience.</p>

  <h3>3. Device Information</h3>
  <p>Our application may automatically collect certain information about your device, such as the type of mobile device you use, your device's unique identifier, operating system version, and other technical details. This data is collected to ensure compatibility, provide updates, and troubleshoot any issues that may arise.</p>

  <h3>4. Third-Party Services</h3>
  <p>"Söderhamns Moské" does not integrate any third-party services, such as analytics, advertising, or social media platforms, that may collect user data. We strive to maintain a secure and private environment for all users.</p>

  <h3>5. Security Measures</h3>
  <p>We employ industry-standard security measures to protect your data from unauthorized access, alteration, or disclosure. However, please note that no method of data transmission or storage is entirely secure, and we cannot guarantee absolute security.</p>
